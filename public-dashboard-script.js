// public-dashboard-script.js (Versão Final Verificada)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Se o elemento da lista não existir nesta página, o script para aqui.
    ...
    const renderDocumentos = (documentos) => {
        ...
        table.className = 'leads-table'; // Reutiliza o estilo da tabela
        const thead = `
            <thead>
                <tr>
                    <th>ID</th>
